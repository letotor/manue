...
--init
-- CREATE USER 'manue'@'%' IDENTIFIED BY 'manue';

-- CREATE DATABASE manue;

-- GRANT ALL PRIVILEGES ON manue.* TO 'manue'@'%';
...
-- Dump completed on 2022-09-25 17:54:27
